...
public class XStream12AnnotationCompatibilityTest extends AbstractAcceptanceTest {
    ...
    public void testImplicitCollection() {
        String expected = ""
            ...
            + "  <string>two</string>\n"
            + "</root>";
        Annotations.configureAliases(xstream, ImplicitCollectionTest_2.ImplicitRootOne.class);
        ImplicitCollectionTest_2.ImplicitRootOne implicitRoot = new ImplicitCollectionTest_2.ImplicitRootOne();
